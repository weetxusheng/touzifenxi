...
set "SOURCE=chip"
set "LOG_TAG=!SOURCE!"
set "CHIP_TO_LIST=zx944532395@sina.com"

rem Repo root = scripts/chip -> two levels up from this file.
...
!PYTHON_CMD! -c "import chip.cli" >nul 2>&1
if errorlevel 1 (
...
!PYTHON_CMD! -m utils.cli run-chip-daily-brief --no-email --to !CHIP_TO_LIST! 2>> "!LOG_FILE!"
