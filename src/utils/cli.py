...
from .tools.settings import ensure_directories, resolve_paths
...
def main() -> None:
    ...
    if args.command == "init-db":
        from .tools.db.storage import ResearchStore
    ...
    if args.command == "send-email":
        from .tools.output.email import send_email
    ...
    if args.command == "run-c114-daily-brief":
        ...
        from c114.pipeline import run_c114_daily_brief, shanghai_yesterday
    ...
    from .tools.market.fundamentals import sync_candidate_financial_profiles
    from .tools.market.industry import fetch_industry_dictionary, sync_candidate_stock_industries
    from .tools.db.migration import migrate_sqlite_to_postgres
    from .tools.models import UniverseFilter
    from .pipeline import DailyResearchPipeline, PipelineConfig
    from .tools.db.storage import ResearchStore
    from .tools.research.tracking import fetch_forward_returns
    from .tools.market.universe import fetch_full_universe
