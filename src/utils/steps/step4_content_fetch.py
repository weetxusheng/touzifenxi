...
from utils.tools.content.fetch import AliyunIQSClient, FetchResult, fetch_article_contents, fetch_url_content
from utils.tools.content.types import (
    VALID_KEEP_LEVELS,
...
from utils.tools.content.yaml_io import load_search_results_yaml
...
def run_content_fetch_workflow(
    ...
    *,
    ...
    runtime_config = load_c114_runtime_config(Path(__file__).resolve().parents[3])
    if fetcher is None:
